            ...
            <a href="javascript:;" class="nav-link text-white font-weight-bold px-0">
              ...
              <ul class="navbar-nav ms-auto">
                ...
                @if(!Auth::guard('admin')->check())
                    @if (Route::has('login'))
                        <li class="nav-item">
                            <a class="nav-link" style="color:white;margin-top:-15px" href="{{ route('admin.showLoginForm') }}">{{ __('Login') }}</a>
                        </li>
                    @endif
                @else
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle" style="color:white;margin-top:-15px" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
